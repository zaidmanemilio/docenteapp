...
export default function ConfigClient({
  courseId, profile, initialCourse, initialCommissions,
  initialPermissions, initialAllProfiles,
}: ConfigClientProps) {
  ...
  // Se sigue usando para refrescar después de guardar / asignar permisos.
